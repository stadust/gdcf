...
INSERT INTO profile
    SELECT username, user_id, stars, demons, creator_points, index_10, index_11, secret_coins, account_id, user_coins, index_18, index_19, youtube_url, cube_index, ship_index, ball_index, ufo_index, wave_index, robot_index, has_glow, index_29, global_rank, index_31, spider_index, twitter_url, twitch_url, diamonds, death_effect_index, CAST(mod_level AS TEXT) AS index_49, index_50
    FROM temp_table;
