...
parser! {
    User => {
        ...
        index_18(index = 18),
        index_19(index = 19),
        youtube_url(index = 20, parse_infallible = YoutubeConverter, optional),
        cube_index(index = 21),
        ship_index(index = 22),
        ball_index(index = 23),
        ufo_index(index = 24),
        ...
        twitter_url(index = 44, parse_infallible = TwitterConverter, optional),
        twitch_url(index = 45, parse_infallible = TwitchConverter, optional),
        diamonds(index = 46),
